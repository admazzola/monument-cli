Phaser.NineImage = function (game, x, y, width, height, key, frame, top, left, bottom, right, repeats) {
    ...
    //PIXI.Sprite.call(this, PIXI.loader.resources['__default'].texture);
    ...
    console.log(this.nineImageFrame)

    // calculate all necessary metrics to render nine image
    this.calculateNineImage(this.nineImageFrame, width, height, top, left, bottom, right, repeats );
...
Phaser.NineImage.prototype.calculateNineImage = function (frame, width, height, top, left, bottom, right, repeats) {
